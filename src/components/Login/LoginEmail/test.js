...
const LoginEmail = () => {
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <form>
                <TextField onBlur={handleInputData} className="login-input" 
                name="firstName" label="First Name" color="secondary" />

                <TextField onBlur={handleInputData} className="login-input" name="lastName" 
                label="Last Name" color="secondary" />

                <TextField onBlur={handleInputData} className="login-input" name="email" 
                label="Username or Email" color="secondary" />

                <TextField onBlur={handleInputData} className="login-input" name="password" 
                label="Password" color="secondary" />

                <TextField onBlur={handleInputData} className="login-input" name="confirmPassword" 
                label="Confirm Password" color="secondary" />

                <Button onClick={handleCreateUser} id="createUser" className="login-input create-btn" 
            ...
            <form>
                ...
                <Button onClick={handleLoginUser} className="login-input login-btn" 
